...
function JoinPage() {
  ...
  // Load invitation when code is available AND user is authenticated
  useEffect(() => {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              קיבלת הזמנה להצטרף לחווה. יש להתחבר כדי לראות את פרטי ההזמנה ולהצטרף.
            </p>
          </div>
  ...
  // Loading invitation state (after logged in)
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
  ...
  // Error state (after trying to load invitation)
  if (error && !invitation) {
    return (
  ...
  // Waiting for invitation to load (user logged in but invitation not loaded yet)
  if (!invitation) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
  ...
  // Main UI - user is logged in and invitation is loaded
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
        {/* Header */}
