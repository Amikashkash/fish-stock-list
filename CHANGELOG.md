...
## [1.18.0] - 2026-01-07 (בתהליך)

### שיפורי UX 🎯
- **איחוד ניהול תוכניות העברות במקום אחד**:
  - הוסר כפתור "רשימת תוכניות" מדף הבית (פחות עומס)
  - מודאל "תכנון העברות" כעת מכיל tabs:
    - ➕ תוכנית חדשה (ברירת מחדל)
    - 📋 תוכניות פתוחות (בפיתוח)
    - 📜 היסטוריה (בפיתוח)
  - זרימה אחת ברורה - כל מה שקשור להעברות במקום אחד

### שינויים טכניים 🔧
- הוספת state `viewMode` ל-TransferPlanModal
- הוספת tabs responsive בראש המודאל
- הוספת פונקציה `loadAllPlans()` לטעינת רשימת תוכניות
- ה-state של TransferPlansListModal יועבר לתוך TransferPlanModal

**הערה**: גרסה זו כוללת את התשתית לאיחוד המודאלים. התוכן של "תוכניות פתוחות" ו"היסטוריה" יתווסף בגרסה הבאה.
